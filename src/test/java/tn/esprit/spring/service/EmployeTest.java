...
import tn.esprit.spring.service.entities.Role;
import tn.esprit.spring.service.repository.ContratRepository;
import tn.esprit.spring.service.repository.DepartementRepository;
import tn.esprit.spring.service.repository.EntrepriseRepository;
import tn.esprit.spring.service.services.EntrepriseServiceImpl;
import tn.esprit.spring.service.services.EmployeServiceImpl;
...
public class EmployeTest {
    ...
    public void testAjoutEmploye() {
        Employe employe = new Employe("bouchareb","hamza","hamza.bouchareb@esprit.tn",true, Role.INGENIEUR);
    ...
    */
    ...
    public void getNombreEmployeJPQL() {
        Employe employee_1 = new Employe("employe", "test", "testemploye@mail.com", true, Role.INGENIEUR);
